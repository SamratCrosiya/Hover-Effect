...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,20,24,6&height=300&section=header&text=CI/CD%20Pipeline&fontSize=90&animation=fadeIn&fontAlignY=38&desc=Jenkins%20%2B%20Docker%20%7C%20Automated%20Deployment&descAlignY=52&descAlign=50&descSize=20)

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=D24939&center=true&vCenter=true&multiline=true&repeat=true&width=850&height=120&lines=🔄+Continuous+Integration+%26+Deployment;🐳+Docker+Containerization+%7C+Jenkins+Automation;⚡+Build+→+Test+→+Deploy+Pipeline;🌐+My+First+DevOps+Project;🎯+Production-Ready+Infrastructure)](https://git.io/typing-svg)

<p align="center">
  <a href="http://98.91.27.90/">
    <img src="https://img.shields.io/badge/Jenkins-Live_Server-D24939?style=for-the-badge&logo=jenkins&logoColor=white&labelColor=000000" alt="Jenkins Live">
  </a>
  <img src="https://img.shields.io/badge/Docker-Enabled-2496ED?style=for-the-badge&logo=docker&logoColor=white&labelColor=000000" alt="Docker">
  <img src="https://img.shields.io/badge/CI/CD-Active-10B981?style=for-the-badge&logo=githubactions&logoColor=white&labelColor=000000" alt="CI/CD">
  <img src="https://img.shields.io/badge/Status-Online-success?style=for-the-badge&logoColor=white&labelColor=000000" alt="Status">
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Jenkins-2.440+-D24939?style=for-the-badge&logo=jenkins&logoColor=white" alt="Jenkins">
...
║                                                                   ║
║    Automated Build, Test, and Deployment using Jenkins & Docker  ║
║                                                                   ║
╚═══════════════════════════════════════════════════════════════════╝
```
...
<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Hammer%20and%20Wrench.png" width="50" align="left" style="margin-right: 10px"/>
...
<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Rocket.png" width="50" align="left" style="margin-right: 10px"/>
...
<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Ship.png" width="50" align="left" style="margin-right: 10px"/>
...
<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Robot.png" width="50" align="left" style="margin-right: 10px"/>
...
<table>
<tr>
<td align="center">🎉<br><b>First DevOps Project</b></td>
<td align="center">🔧<br><b>Self-Hosted Jenkins</b></td>
<td align="center">🐳<br><b>Docker Mastery</b></td>
<td align="center">⚡<br><b>Live Production</b></td>
...
[![Jenkins Server](https://img.shields.io/badge/🔗_Live_Jenkins_Server-Click_Here-D24939?style=for-the-badge&logo=jenkins&logoColor=white)](http://98.91.27.90/)
...
<img src="https://via.placeholder.com/500x300/D24939/ffffff?text=Jenkins+Dashboard" alt="Jenkins Dashboard" width="100%"/>
<br><b>🎛️ Jenkins Dashboard</b>
<br><sub>Monitor all pipelines • Build history • Job status</sub>
</td>
<td width="50%" align="center">
<img src="https://via.placeholder.com/500x300/2496ED/ffffff?text=Pipeline+View" alt="Pipeline" width="100%"/>
...
<tr>
<td width="50%" align="center">
<img src="https://via.placeholder.com/500x300/10B981/ffffff?text=Docker+Containers" alt="Docker" width="100%"/>
<br><b>🐳 Docker Containers</b>
<br><sub>Active containers • Image management • Logs</sub>
</td>
<td width="50%" align="center">
<img src="https://via.placeholder.com/500x300/F59E0B/ffffff?text=Build+Analytics" alt="Analytics" width="100%"/>
...
graph TB
    ...
    subgraph "CI/CD Server - 98.91.27.90"
        E[🎯 Jenkins Master]
        F[🔄 Pipeline Engine]
        G[🐳 Docker Engine]
    end
    ...
    style E fill:#D24939,stroke:#a83232,stroke-width:3px,color:#fff
    style G fill:#2496ED,stroke:#1a75bb,stroke-width:3px,color:#fff
    style N fill:#10B981,stroke:#059669,stroke-width:3px,color:#fff
```
...
graph LR
    ...
    B -->|Detected| C[🎯 Jenkins Pipeline Start]
    C --> D[📥 Clone Repository]
    D --> E[🔨 Build Stage]
    
    E --> F{✅ Build Success?}
    F -->|Yes| G[🧪 Test Stage]
    F -->|No| X[❌ Notify Failure]
    ...
    L --> M{🚀 Deploy?}
    M -->|Production| N[🌐 Deploy Container]
    ...
    style C fill:#D24939,stroke:#a83232,stroke-width:2px,color:#fff
    style I fill:#2496ED,stroke:#1a75bb,stroke-width:2px,color:#fff
